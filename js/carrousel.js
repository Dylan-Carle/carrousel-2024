(function(){
    ...
    if(carrousel){
        ...
        let conteneur__fleche = document.createElement("div");
        conteneur__fleche.classList.add('conteneur__fleche');
        ...
        carrousel.appendChild(conteneur__fleche);
        conteneur__fleche.appendChild(fleche__gauche);
        conteneur__fleche.appendChild(fleche__droite);
